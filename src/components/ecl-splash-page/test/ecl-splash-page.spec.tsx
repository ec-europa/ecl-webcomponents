...
import { EclSplashPage } from '../ecl-splash-page';
import { EclSplashPageLanguageItem } from '../ecl-splash-page-language-item';

describe('ecl-splash-page', () => {
  it('renders', async () => {
    const page = await newSpecPage({
      components: [EclSplashPage, EclSplashPageLanguageItem],
      html: `<ecl-splash-page
              language="EN"
              lang-code="en"
