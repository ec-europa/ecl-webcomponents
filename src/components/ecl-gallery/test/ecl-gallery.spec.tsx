    ...
    const page = await newSpecPage({
      ...
      >
        <ecl-gallery-item
          ...
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image.jpg"
          image-alt="Image 1"
        >    
        ...
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image2.jpg"
          image-alt="Image 2"
        >
        ...
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image3.jpg"
          image-alt="Image 3"
        >
        ...
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image4.jpg"
          image-alt="Image 3"
        >
        ...
        >
          ...
          <video
            ...
            poster="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image5.jpg"
          >
            <source
        ...
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image6.jpg"
          image-alt="Image 6"
        >
        ...
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image7.jpg"
          image-alt="Image 7"
        >
        ...
        <ecl-gallery-item
          ...
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image8.jpg"
          image-alt="Image 8"
        >
          Teaching material about the EU, including books and maps
        </ecl-gallery-item>
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image9.jpg"
          image-alt="Image 9"
        >
          About the EU
        </ecl-gallery-item>
        <ecl-gallery-item
          ...
          media-share-path="/example.html"
          media-href="https://inno-ecl.s3.amazonaws.com/media/examples/example.html-image10.jpg"
          image-alt="Image 10"
        >
          EU by topic
        </ecl-gallery-item>
