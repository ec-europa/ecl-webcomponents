...
module.exports = {
  scripts: [
    {
      entry: path.resolve(nodeModules, '@ecl/gallery/gallery.js'),
  ...
  styles: [
    ...
    {
      entry: path.resolve(__dirname, 'src/styles/ecl-gallery-item.scss'),
      dest: path.resolve(outputFolder, 'styles/ecl-gallery-item.css'),
      options: {
        banner,
        includePaths,
        sourceMap: false,
