...
import { EclTable } from '../ecl-table';
...
const headersMultiple = [
  ...
  [
    { label: 'Organization', headers: 'el-id-header-3' },
    { label: 'Type of contract', headers: 'el-id-header-3' },
  ],
];
...
describe('ecl-table', () => {
  ...
  it('sortable renders correctly', async () => {
    const page = await newSpecPage({
      components: [EclTable],
      html: `<ecl-table
        el-id="table-id"
