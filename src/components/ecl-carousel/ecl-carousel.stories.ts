...
const Template = (args) => 
  ...
  >
    ...
    <ecl-carousel-item
      ...
      banner-title="Integer quis lorem tellus. Nullam"
    >
      Integer quis lorem tellus. Nullam sollicitudin suscipit diam, ac blandit ipsum tempor consectetur
    </ecl-carousel-item>
    <ecl-carousel-item
    ...
    <ecl-carousel-item
      ...
      size="${args.size}"
      cta-label="Subscribe"
      image="https://inno-ecl.s3.amazonaws.com/media/examples/example-image6.jpg"
      banner-title="Nullam sollicitudin suscipit diam"
      credit="© Copyright or credit"
    >
      Integer quis lorem tellus. Nullam sollicitudin suscipit diam, ac blandit ipsum tempor consectetur
    </ecl-carousel-item>
    <ecl-carousel-item
      ...
      size="${args.size}"
      cta-label="Subscribe"
      image="https://inno-ecl.s3.amazonaws.com/media/examples/example-image7.jpg"
