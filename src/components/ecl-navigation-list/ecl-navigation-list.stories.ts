...
const getArgTypes = () => ({
  variant: {
    control: { type: 'select' },
    options: ['default', 'illustration', 'image-as-illustration'],
  ...
  >
    ...
    >
      <ecl-content-block
        ...
        has-title
        has-description
        has-links="${args.variant === ''}"
        has-secondary-links="${args.variant === ''}"
      >
        <ecl-link
          theme="${args.theme}"
          slot="title"
